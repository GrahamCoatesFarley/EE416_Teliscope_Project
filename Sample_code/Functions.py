import serial                                           # Library used for communicating through Uart
import time                                             # Library used for adding delays within code
...
def Get_User_angles(): 
    ...
    return (float(horz_angle), float(vert_angle))       # Returns two angles 
...
# Get serial port
def GetPort():
	port = input("Input COM port: ")                    # Prompts user for COM port
